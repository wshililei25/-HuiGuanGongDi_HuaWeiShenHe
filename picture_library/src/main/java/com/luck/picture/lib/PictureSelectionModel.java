...
public class PictureSelectionModel {
    ...
    private boolean isUseDoodle;

    public PictureSelectionModel isUseDoodle(boolean isUseDoodle) {
        this.isUseDoodle = isUseDoodle;
        return this;
    }
    ...
    public void forResult(int requestCode) {
        if (!DoubleUtils.isFastDoubleClick()) {
            ...
            if (selectionConfig.camera && selectionConfig.isUseCustomCamera) {
                ...
                intent.putExtra("isUseDoodle",isUseDoodle);
            }
