...
public class VerticalAxesAdapter extends BaseQuickAdapter<VerticalAxesSelectBean, BaseViewHolder> {

    public VerticalAxesAdapter() {
        super(R.layout.layout_item_building_no);
    }

    @Override
    protected void convert(@NotNull BaseViewHolder baseViewHolder, VerticalAxesSelectBean bean) {
