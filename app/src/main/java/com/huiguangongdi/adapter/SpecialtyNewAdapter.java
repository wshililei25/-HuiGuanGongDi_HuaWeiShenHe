...
public class SpecialtyNewAdapter extends BaseQuickAdapter<SpecialtyBean, BaseViewHolder> {

    public SpecialtyNewAdapter() {
        super(R.layout.layout_item_specialty_new);
    }
