...
public class ToDoSafeAdapter extends BaseQuickAdapter<ToDoBean, BaseViewHolder> {

    private Activity mActivity;

    public ToDoSafeAdapter(Activity activity) {
        super(R.layout.layout_item_todo);
        mActivity = activity;
    }

    @Override
    protected void convert(@NotNull BaseViewHolder baseViewHolder, ToDoBean bean) {
