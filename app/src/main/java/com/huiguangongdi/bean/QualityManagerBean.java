...
public class QualityManagerBean implements Parcelable {
    ...
    protected QualityManagerBean(Parcel in) {
        id = in.readInt();
        uid = in.readInt();
        name = in.readString();
    ...
    public static final Creator<QualityManagerBean> CREATOR = new Creator<QualityManagerBean>() {
        @Override
        public QualityManagerBean createFromParcel(Parcel in) {
            return new QualityManagerBean(in);
        }

        @Override
        public QualityManagerBean[] newArray(int size) {
            return new QualityManagerBean[size];
        }
    };
}
