...
public class QualityManagerPresenter extends BasePresenter<QualityManagerView> {

    public void getQualityManager(QualityManagerReq req) {
        RetrofitUtil.getInstance().getQualityManager(req)
