...
public class CreateQualityPresenter extends BasePresenter<CreateQualityView> {
    ...
    public void createQuality(CreateQualityReq req) {
        RetrofitUtil.getInstance().createQuality(req)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread(), true)
