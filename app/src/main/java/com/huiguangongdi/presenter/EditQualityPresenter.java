...
public class EditQualityPresenter extends BasePresenter<EditQualityView> {
    ...
    public void editQuality(EditQualityReq req) {
        RetrofitUtil.getInstance().editQuality(req)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread(), true)
