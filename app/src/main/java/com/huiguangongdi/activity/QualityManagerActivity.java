...
import com.huiguangongdi.presenter.QualityManagerPresenter;
...
import com.huiguangongdi.view.QualityManagerView;
 ...
 * 质量管理
 */
public class QualityManagerActivity extends BaseActivity<QualityManagerPresenter> implements QualityManagerView, View.OnClickListener {
    ...
    @Override
    protected QualityManagerPresenter getPresenter() {
    ...
    private void initRecyclerView() {
        ...
        mAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter<?, ?> adapter, @NonNull View view, int position) {
                ...
                intent.setClass(QualityManagerActivity.this, QualityManagerDetailActivity.class);
    ...
    protected void initListener() {
        ...
        mTitleBar.getRightTv().setOnClickListener(view -> {
            ...
            intent.putExtra(Extra.Quality_or_Safe, true);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.createIv:
                startActivity(new Intent(this, CreateQualityActivity.class));
                break;
            case R.id.allTv:
                initStatusPopup();
                break;
    ...
    private void initStatusPopup() {
        ...
        mQualityStatusAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter adapter, @NonNull View view, int position) {
                ...
                mAllTv.setTextColor(ContextCompat.getColor(QualityManagerActivity.this, R.color.c_0071BC));
    ...
    private void initCompanyPopup() {
        ...
        mQualityCompanyAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter adapter, @NonNull View view, int position) {
                ...
                mCompanyTv.setTextColor(ContextCompat.getColor(QualityManagerActivity.this, R.color.c_0071BC));
    ...
    private void initSpecialtyPopup() {
        ...
        mQualitySpecialtyAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter adapter, @NonNull View view, int position) {
                ...
                mProfessionTv.setTextColor(ContextCompat.getColor(QualityManagerActivity.this, R.color.c_0071BC));
                ...
                .setLayoutRes(R.layout.dialog_quelity_date, new CustomListener() {
                    ...
                    public void customLayout(View v) {
                        ...
                        v.findViewById(R.id.confirmBtn).setOnClickListener(v1 -> {
                            ...
                            mDateTv.setTextColor(ContextCompat.getColor(QualityManagerActivity.this, R.color.c_0071BC));
    ...
    private void getQualityManager() {
        ...
        mPresenter.getQualityManager(mQualityManagerReq);
    }
