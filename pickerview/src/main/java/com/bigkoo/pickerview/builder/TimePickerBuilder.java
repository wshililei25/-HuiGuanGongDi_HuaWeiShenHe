...
public class TimePickerBuilder {
    ...
    public TimePickerBuilder isShowTop(boolean isShowTop) {
        mPickerOptions.isShowTop = isShowTop;
        return this;
    }

    public TimePickerBuilder setTopMargin(int topMargin) {
        mPickerOptions.topMargin = topMargin;
        return this;
    }
